...
way_point_text = open("interpolated_path.txt", "r")
first_text = open("result/first_50.txt", "r")
second_25_text = open("result/second_25.txt", "r")
second_50_text = open("result/second_50.txt", "r")
second_75_text = open("result/second_75.txt", "r")
second_100_text = open("result/second_100.txt", "r")
